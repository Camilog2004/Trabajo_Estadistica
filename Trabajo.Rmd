...
tabla <- base.diagnostico[base.diagnostico$hii.value > hii.criterio, ]

rownames(tabla) <- c("1","24","28","34","38")
tabla %>% 
  kable(col.names = c("Residuales estudentizados", "Distancia Cook", "Valores $h_{ii}$", "Dffits"),caption = "Puntos de balanceo", escape=F, booktab=T, align = "c", row.names = T, digits = 4) %>% 
  kable_styling(latex_options = c("HOLD_position"))
