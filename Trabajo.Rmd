...
tabla %>% 
  kable(col.names = c("Residuales estudentizados" ,"Valores $h_{ii}$"),caption = "Puntos influenciales", escape=F, booktab=T, align = "c", row.names = T, digits = 4) %>% 
  kable_styling(latex_options = c("HOLD_position"))
...
tabla %>% 
  kable(col.names = c("Residuales estudentizados" ,"Dffits"),caption = "Puntos influenciales", escape=F, booktab=T, align = "c", row.names = T, digits = 4) %>% 
  kable_styling(latex_options = c("HOLD_position"))
